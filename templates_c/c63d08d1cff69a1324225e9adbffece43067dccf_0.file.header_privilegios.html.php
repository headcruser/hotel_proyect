...
function content_5848c8a611fee0_81383239 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!-- header privilegios -->
<header>
  <div id="enlaces">
              ...
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">
                  ...
                  <ul class="dropdown-menu" role="menu">
                      <li><a href="../cliente/facturacion.php">Facturación Electronica</a></li>
                  </ul>
              </li>
            <?php }?>
